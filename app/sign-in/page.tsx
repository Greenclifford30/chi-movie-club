    ...
    <AuthShell>
      <form onSubmit={handleSubmit} className="flex flex-col justify-center p-5 sm:p-8">
        ...
        <div className="space-y-4">
          ...
          <Button type="submit" disabled={isSubmitting || isGoogleSubmitting} className="w-full bg-violet-400 text-slate-950 hover:bg-violet-300">
          ...
          <p className="text-center text-sm text-slate-400">
            Need an account?{" "}
            <Link href={`/sign-up?redirect=${encodeURIComponent(redirect)}`} className="font-medium text-violet-200 hover:text-violet-100">
              Sign up
            </Link>
          </p>
        </div>
