...
function SignUpContent() {
  ...
  return (
    <AuthShell>
      {needsConfirmation ? (
        <form onSubmit={handleConfirm} className="flex flex-col justify-center p-5 sm:p-8">
          <div className="mb-8">
        ...
        <form onSubmit={handleSignUp} className="flex flex-col justify-center p-5 sm:p-8">
          <div className="mb-8">
